const quiz = [
    {
      id: 1,
      ques: 'How many key word in java?',
      ans: '50',
      options: ["34", "50", "62"],
    },
    {
    ...
    {
      id: 3,
      ques: 'Arrays in java are-',
      ans: 'object',
      options:  ["7", "Primitive_datatype", "None", "object"],
    },
    {
      id: 4,
      ques: 'Output of Math.floor(3.6)?',
      ans: '3.0',
      options: ["3", "3.0", "5"],
    },
    {
      id: 5,
      ques: 'What is Runnable?',
      ans: 'Interface',
      options:  ["Abstract class", "Interface", "Method"],
    },
  ];
